...
page1 = st.Page(str(BASE / "dashboard" / "pagina2.py"), title="Página 1", icon=":material/filter_1:")
page2 = st.Page(str(BASE / "dashboard" / "pagina1.py"), title="Página 2", icon=":material/filter_2:")
page3 = st.Page(str(BASE / "dashboard" / "pagina3.py"), title="Página 3", icon=":material/filter_3:")

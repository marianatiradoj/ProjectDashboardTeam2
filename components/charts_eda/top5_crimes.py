...
def render_top5_crimes_bar(
    ...
    """
    Render top 5 crime groups by percentage with global filters.
    Crime type filter is ignored to show global composition.
    """
    ...
    counts = df_f[DELITO_MACRO_COL].value_counts(normalize=False).head(5).reset_index()
